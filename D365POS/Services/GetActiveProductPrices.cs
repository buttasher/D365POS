...
namespace D365POS.Services
{
    public class GetActiveProductPrices
    {
        ...
        private readonly string _url = "https://aduat.sandbox.operations.uae.dynamics.com/api/services/TBInventoryServices/TBPOSOperationService/getActiveProductPrices";
